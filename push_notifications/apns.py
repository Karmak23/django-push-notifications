...
def _apns_create_socket_to_push():
	return _apns_create_socket((str(SETTINGS["APNS_HOST"]), SETTINGS["APNS_PORT"]))


def _apns_create_socket_to_feedback():
	return _apns_create_socket((str(SETTINGS["APNS_FEEDBACK_HOST"]), SETTINGS["APNS_FEEDBACK_PORT"]))
